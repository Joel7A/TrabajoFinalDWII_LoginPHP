...
/* login */
	...
	$password_encriptada = sha1($password); /* aqui estoy encriptando la contraseña para la base de datos */
...
if (isset($_POST["registrar"])){
	...
	if($filas > 0){
		...
		/* introduccion del nombre del usuario */
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">construyendo el futuro</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="social-login center">
												<a href="#" target="_blank" class="btn btn-danger"><!-- referenciar a youtube -->
													<i class="ace-icon fa fa-youtube" ></i>
												</a>
												<a href="#" target="_blank" class="btn btn-primary"><!-- referenciar a facebook -->
													<i class="ace-icon fa fa-facebook"></i>
												</a>

												<a href="#" target="_blank" class="btn btn-info"><!-- refenciar a twiter -->
													<i class="ace-icon fa fa-twitter"></i>
												</a>

												<a href="#" target="_blank" class="btn btn-danger"><!-- referenciar a instagram -->
...
<!-- scripts en línea relacionados con esta página -->
		<script type="text/javascript">
			jQuery(function($) {
